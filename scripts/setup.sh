...
# go to the directory on the dataset first
current_dir=`pwd`

mkdir $current_dir/zfs_libs

# be advised that the following paths were not available and I needed to change the files to the newest version available on the system!
